...
The party looks for a way to reply to the letter ([AA06-L-1](../../papers/letters/AA06-L-1.md)). They find their way to [Astpost Northhaven](../../places/buildings/shops/astpost-northhaven.md), where they are greeted by a postal worker who initially doesn't believe [Ephaine Seren](../../characters/ephaine-seren.md) has business sending a letter to an [Astornar](../../organisations/astornar.md) General. Upon producing the letter, his doubt is assuaged, and he lets her send the letter to Liabella for 2 cp.
