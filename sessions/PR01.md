...
Torbra asks more probing questions about Wrenn's thirst for knowledge, inquiring about where he sources his materials. Wrenn indicates that he has access to a large library in [Northhaven](../places/cities/northhaven.md) that's only available to [Astornox](../organisations/government/astornox/astornox.md) like himself. Torbra agrees to work for him if he's able to provide Torbra with information from the library.
