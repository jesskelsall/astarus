...
Hidaar makes their way over to the other side of the room, pulling their copy of the [Astorrel Map of South East Kardan](../maps/astorrel-map-of-south-east-kardan.md) from a side unit's drawer and unrolling it on the war table. [Thanea](../../../astarus/people/thanea.md) puts Wrenn's [Meteoric Map of Astor](../maps/meteoric-map-of-astor.md) next to it. The party spend some time comparing the two maps while [Thanea](../../../astarus/people/thanea.md) amends Wrenn's map, making notes about what is near to the blue crosses on it.
...
Hidaar tells Sparrow that it is a priority to get the party into the [Northhaven Astorrel Stronghold](../places/strongholds/northhaven-astorrel-stronghold.md) as soon as possible. Sparrow expresses concern about getting the [Astorrel guards](../organisations/government/astorrel/ranks/astorrel-guard.md) on the gatehouse to let them in, but that it is a problem for later.
