...
[Wizira](../characters/wizira.md) asks who gave the [Astornox](../organisations/astornox/astornox.md) their order to hunt down [magicborn](../civilisations/kingdom-of-astor/magicborn.md). Hidaar offers a history lesson: General Supreme Corville Thornox ordered it so during the Astor-Syntenne War, and that since the armistice, the order has remained in place.
