...
For the rest of the morning and into the early afternoon, the coach proceeds without incident towards [Starnov](../places/cities/starnov.md), arriving there not long after midday. As the party look out of the window they see the outskirts of [Starnov](../places/cities/starnov.md) as buildings and urban sprawl become more common. Kera sticks his tongue out of the window to get any fresh air he can, still not coping well with enclosed transport.

## Arriving in [Starnov](../places/cities/starnov.md)

As the coach works its way towards the [Starnov](../places/cities/starnov.md) city centre, the party discuss their plans while in the [Nilus Coast](../civilisations/nilsavnic-alliance/states/nilus-coast.md) capital. Almost everyone has shopping needs, so that becomes the agreed first order of business. [Nainarv Hardhelm](../characters/nainarv-hardhelm.md) is happy to tag along, no specific business of his own to attend to.
...
[Marik Kaligavone](../characters/marik-kaligavone.md) puts up her hood before pulling [Keranios](../characters/keranios.md) to one side while the rest of the party try to figure out where to go next. She impresses upon her unhappiness at being back in [Starnov](../places/cities/starnov.md) due to their [Marsh Skimmers](../organisations/marsh-skimmers.md) bounty, noting that they aren't likely to be safe here. She asks Kera to keep a low profile, but he points out his minotaur lineage and height will make it hard to remain inconspicuous. The pair resolve to keep their eyes out and be careful.

## Starting with Shopping

The party begins their time in [Starnov](../places/cities/starnov.md) by taking care of some shopping errands.
...
## News of [Côtedouce](../places/towns/cotedouce.md)
...
Marik is frustrated, asking [Crucible](../characters/crucible.md) how she intends for them to succeed if the [Marsh Skimmers](../organisations/marsh-skimmers.md) pose a danger to their mission. [Crucible](../characters/crucible.md) gives a wry grin, savouring the moment before answering. She doesn't necessarily expect them to succeed, as the odds are stacked against them, but encourages the pair to surprise her.

Marik assures [Crucible](../characters/crucible.md) that they will succeed and on time. They have gained the trust of their targets and believe them to be carrying something "better than [Unevaire](../items/artifacts-of-oonar/weapons/unevaire.md)", which catches [Crucible](../characters/crucible.md)'s curiosity. She hopes they are right.
...
Kera tells the party that Marik promised something better than [Unevaire](../items/artifacts-of-oonar/weapons/unevaire.md), eliciting a frustrated sigh from Vētrall who chastises Marik for making their task harder than it needed to be. Marik asks if Vētrall knows where [Unevaire](../items/artifacts-of-oonar/weapons/unevaire.md) is. Vētrall explains that one of the Vulpes family will have inherited it following [Vulpes Geen](../characters/vulpes-geen.md)'s death, but they don't know who.

The party discuss what the [Marsh Skimmers](../organisations/marsh-skimmers.md) could give [Crucible](../characters/crucible.md). Marik suggests just giving her the [Fall of Chausain Memory Sphere](../items/artifacts-of-oonar/memory-spheres/fall-of-chausain-memory-sphere.md), making the artifact her problem, and likely bringing the misfortune that follows the [memory sphere](../items/artifacts-of-oonar/memory-spheres/memory-sphere.md) to the [Marsh Skimmers](../organisations/marsh-skimmers.md). They could wash their hands of the entire situation. Vētrall is opposed to the idea, wanting to figure out what it is or does.
...
The party considers their continued intent to go to [Hochwald](../places/cities/hochwald.md) to meet with [Disanz Brickbrow](../characters/disanz-brickbrow.md) in [Hochwald](../places/cities/hochwald.md), who might be able to help them find [Raine Soulier](../characters/raine-soulier.md). The party decides that as the journey to [Hochwald](../places/cities/hochwald.md) will take 3 of 4 days, they will wait until they arrive in the [Valburg](../civilisations/nilsavnic-alliance/states/valburg.md) capital before handing something over to the [Marsh Skimmers](../organisations/marsh-skimmers.md), giving them enough time to decide exactly what that will be.

## An Evening in the City

[Keranios](../characters/keranios.md) and [Valan Shadowgaze](../characters/valan-shadowgaze.md) head back out into the streets of [Starnov](../places/cities/starnov.md) to search for more information about what happened to [Côtedouce](../places/towns/cotedouce.md).
...
## Heading to [Golfmaul](../places/towns/golfmaul.md)
...
Consulting their map ([Independent States of the Nil'Savnic Alliance](../maps/independent-states-of-the-nilsavnic-alliance.md)), the party considers the possibility of taking a ship to [Golfmaul](../places/towns/golfmaul.md) to reduce the amount of over-land travel they need to make, and the dangers that come with it. While Marik and Nainarv enjoy their breakfast, Kera and Valan once again head out to investigate.
...
| --- | --- | --- |
| | [Arrepont](../places/cities/arrepont.md) | Midday |
| [Montrose](../places/ships/montrose.md) | [Golfmaul](../places/towns/golfmaul.md) | Sunset |

Kera learns that the [Montrose](../places/ships/montrose.md) came from Kurzu and is headed to [Golfmaul](../places/towns/golfmaul.md) at sunset, looking to avoid the busy ship traffic at this end of the [Gulf of Tanelle](../places/seas-oceans/gulf-of-tanelle.md) by night. The captain offers the party passage to [Golfmaul](../places/towns/golfmaul.md) for 1 sp each, which Kera accepts, paying for all five people.

With the party's travel plans secured for that evening, the party has the rest of the day in [Starnov](../places/cities/starnov.md), though most choose to remain in [the Round Goose](../places/buildings/inns-taverns/the-round-goose.md) and enjoy a quiet sit.

[Vētrall Astérr](../characters/vetrall-asterr.md) takes off alone to search for more information on what happened in [Côtedouce](../places/towns/cotedouce.md) but learns no more than Kera and [Valan Shadowgaze](../characters/valan-shadowgaze.md) did. They find the traders give them a wide berth, interpreting their line of questions and attire as some sort of salesperson, treating them with suspicion.

Vētrall then goes down to the dock for the rest of the afternoon, sitting on the dock, watching the ships come and go across the [Gulf of Tanelle](../places/seas-oceans/gulf-of-tanelle.md). They are afforded a clear view of the spires of [Arrepont](../places/cities/arrepont.md) and of central [Savnia](../civilisations/nilsavnic-alliance/states/savnia.md) across the gulf.
...
The party wakes early the following morning, the [Montrose](../places/ships/montrose.md) not far from [Golfmaul](../places/towns/golfmaul.md). The day is cloudy. Before long the ship docks in one of the three parallel dock spots at the base of the town.

## Arriving in [Golfmaul](../places/towns/golfmaul.md)
...
> Hallo, wilkommen in [Golfmaul](../places/towns/golfmaul.md).

The human male [Waldwächter](../organisations/guards/waldwachter.md) immediately realises that the party doesn't speak [Valburgisch](../languages/valburgisch.md) and switches to common, while his ginger haired dwarven counterpart watches on silently. He asks the party what their business is in [Golfmaul](../places/towns/golfmaul.md).

Vētrall explains that they're from [Trest](../places/towns/trest.md) and are making their way to [Hochwald](../places/cities/hochwald.md), just passing through. The guard recognises [Trest](../places/towns/trest.md) and asks if they know of [Familia Vulpes](../organisations/familia-vulpes.md). Vētrall's face lights up as they explain that they are part of [Familia Vulpes](../organisations/familia-vulpes.md). The guard takes it as a joke, not expecting the party to actually be reputable adventurers. This offends Vētrall who worries that they don't look the part.

Vētrall pulls out their [Coin of Friendship](../items/coin-of-friendship.md) which immediately convinces the [Waldwächter](../organisations/guards/waldwachter.md) who hastily apologies. He asks [Keranios](../characters/keranios.md) and [Marik Kaligavone](../characters/marik-kaligavone.md) if they are members of [Familia Vulpes](../organisations/familia-vulpes.md) too, but Marik says that they are merely associates of Vētrall and [Valan Shadowgaze](../characters/valan-shadowgaze.md).

The [Waldwächter](../organisations/guards/waldwachter.md) encourages them to check the notice board up the street, noting that the Knight of [Golfmaul](../places/towns/golfmaul.md) is requesting the help of adventurers and is paying for their services. Vētrall asks for specifics, but the guard points them to the board for the full details. He only mentions that it is a pest problem around [Sonnigeweide](../places/villages/sonnigeweide.md).

The party begin to make their way up the switchback main street of [Golfmaul](../places/towns/golfmaul.md). As they go they note the pastel coloured buildings, with Valan making comparison between a baby blue building and Vētrall.
...
## Walking to [Sonnigeweide](../places/villages/sonnigeweide.md)

In agreement that [Sonnigeweide](../places/villages/sonnigeweide.md) is a minor detour and that the party would like to help with the wolf problems there, the party make their way up the rest of the road, reaching Lilaweg as the land flattens out. Here they notice smaller and less impressive lower class dwellings, as well as stables on the opposite side of the road. Feeling that their journey to [Sonnigeweide](../places/villages/sonnigeweide.md) will be short, they simply decide to walk it.
...
## Arriving in [Sonnigeweide](../places/villages/sonnigeweide.md)

[Vētrall Astérr](../characters/vetrall-asterr.md) leads the party across the grassy plains for 30 minutes, [Sonnigeweide](../places/villages/sonnigeweide.md) coming into view ahead of them. Eventually the grass turns to farmers' fields, not currently being cultivated after the recent autumn harvest. Between two fields is a trench with a stream flowing heavily at its bottom, swelled from yesterday's rain. Vētrall leads the party along the side of the field and crosses over at a cobble stone bridge.
...
Once everyone is enjoying their food and each others' company, [Valan Shadowgaze](../characters/valan-shadowgaze.md) gets up and heads back into the kitchen. There he quietly gets [Askad Greybelt](../characters/askad-greybelt.md)'s attention, giving her the letter ([MC06-L-1](../letters/MC06-L-1.md)) and asking if she'll give it to "the blue one" in 5 minutes. Askad is confused but agrees, not sure what is happening.
...
Vētrall hears the sound of running through the streets of [Sonnigeweide](../places/villages/sonnigeweide.md), taking off at speed in their direction. They're able to follow them for a while, shouting at Valan to get back here while giving chase. Valan runs away, seeking a hiding spot.
...
> Hello, my name is [Lorena Bynelor](../characters/lorena-bynelor.md), [Waldwächter](../organisations/guards/waldwachter.md) Knight of [Golfmaul](../places/towns/golfmaul.md). Are you here about the wolves?
